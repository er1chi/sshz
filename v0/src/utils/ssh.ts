...
export function appendSshHost(alias: string, hostname: string, user: string, port?: string, identityFile?: string) {
...
export function getHostDetails(alias: string): { alias: string; hostname: string; user: string; port: string; identityFile: string } | null {
  const configPath = path.join(os.homedir(), ".ssh", "config")
...
export function updateSshHost(oldAlias: string, alias: string, hostname: string, user: string, port?: string, identityFile?: string): boolean {
  const configPath = path.join(os.homedir(), ".ssh", "config")
